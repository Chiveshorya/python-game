...
img_Apple = pygame.image.load("icons8-apple-20.png")
img_Icon = pygame.image.load("icons8-snake-32.png")
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("Если ты ударишься о границы игры или по себе, ты проиграешь.",
                          colour=BLACK,
                          y_displace=50)
        message_to_screen("Нажми C чтобы начать игру, SPACE для паузы и Q чтобы выйти.",
                          colour=RED,
                          y_displace=150)
...
def pause():
    ...
    message_to_screen("Нажмите C чтобы продолжить игру или Q для выхода",
                      BLACK,
                      25)
